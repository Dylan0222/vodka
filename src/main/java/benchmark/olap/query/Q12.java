...
public class Q12 extends baseQuery {
    ...
    public String getDeltaTimes() throws ParseException {
        ...
        // log.info("#12: countNumber:" + countNumber + ",size:" +
        // OLAPTerminal.orderlineTableNotNullSize);
        ...
        // OrderLine orderLine =
        // ReservoirSamplingSingleton.getInstance().getOrderLine(filterRate);
...
// SELECT COUNT(*) FILTER (where ol_receipdate < TIMESTAMP '1994-01-06
// 01:52:22.068' )::NUMERIC / COUNT(*) FROM vodka_order_line where ol_receipdate
// IS NOT NULL;