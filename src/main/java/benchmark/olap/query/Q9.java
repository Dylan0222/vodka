    ...
    public String getQuery() {
        ...
        switch (this.dbType) {
            case CommonConfig.DB_TIDB:
                ...
                break;
            default:
                // query = "select count(*) from vodka_supplier, vodka_stock, vodka_order_line,
                // vodka_item, vodka_oorder WHERE ol_suppkey = vodka_supplier.s_suppkey and
                // ol_i_id = vodka_stock.s_i_id and ol_supply_w_id = vodka_stock.s_w_id and i_id
                // = ol_i_id and o_w_id = ol_w_id and o_d_id = ol_d_id and o_id = ol_o_id and
                // i_name like '%green%' limit 100;";
                query = "select " +
                        " nation, " +
                        " o_year, " +
                        " sum(amount) as sum_profit " +
                        ...
                        // " s_suppkey = ol_suppkey " +
                        // " and s_tocksuppkey = ol_suppkey " +
                        "WHERE ol_suppkey = vodka_supplier.s_suppkey " +
